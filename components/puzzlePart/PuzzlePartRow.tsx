...
const PuzzlePartRow: FC = () => {
  ...
  return (
    <li>
      <div className="grid items-center grid-cols-4 px-4 py-4 bg-vscode-panel-bg sm:px-6 lg:px-8">
        <div className="flex items-center gap-x-3 text-vscode-text-primary">
