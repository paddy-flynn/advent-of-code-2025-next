...
const RunAllButton: FC<{ allDays: string[] }> = ({ allDays }) => {
  ...
  return (
    <button
      className="inline-flex items-center justify-center px-4 py-2 text-sm font-medium bg-accent-gold border border-transparent rounded-md shadow-sm max-sm:w-full text-white hover:bg-white hover:text-accent-gold focus:outline-none focus:ring-2 focus:ring-accent-gold focus:ring-offset-2 sm:w-auto disabled:opacity-50 disabled:cursor-not-allowed ring-offset-transparent transition-all duration-200 backdrop-blur-md glow-gold"
      type="button"
